...
entity top_design is
    ...
    Port ( in1 : in STD_LOGIC_VECTOR (1 downto 0);
           ...
           out1 : out STD_LOGIC;
           in_1_generic : in std_logic_vector((width - 1) downto 0);
           not_in_1_generic : out std_logic_vector((width - 1) downto 0)
          );
end top_design;
...
-------NOT GENERIC COMPENENT------
component not_component_generic is
...
begin
    ...
    comp_4 : not_component_generic 
        Generic map (
                      data_bit => width
                     )
        Port map (
                  in_1    => in_1_generic,
                  not_in1 => not_in_1_generic
                  );
